document.addEventListener('DOMContentLoaded', function() {
    ...
    async function loadNews(limit = null, containerId = 'all-news-container') {
        try {
            ...
            const response = await fetch('https://api.grueneeule.de/v1/news/data/news.json');
            ...
            container.innerHTML = newsToDisplay.map(news => `
                <div class="news-card fade-in">
                    <img src="${news.image}" alt="${news.title}" class="news-card-image" onerror="this.src='/assets/img/news/default.jpg'">
            ...
            // Wenn auf news.html, Suchfunktion einrichten
